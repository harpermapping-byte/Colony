...
- **`assets/`** — arte por convención de nombre = id de catálogo (`<categoria>/<id>_<NN>.png|.glb`). Placeholders regenerables con `baker/src/generar_placeholders.js` (solo crea los que faltan). `assets/mapas/demo/` es el mapa que carga el cliente.
