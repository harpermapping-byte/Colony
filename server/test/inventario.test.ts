...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 244); // 240 (211 agricultura/pesca/cocina/equipo/caza/ganadería + 28 semilla_<especie> de árbol + silla_montar) + barco_1..4 (docs/GDD_Barcos.md, 2026-08-30)
