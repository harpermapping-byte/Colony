...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 779); // 665 (ver historial) + 114 de la ampliación de coherencia del catálogo (2026-09-11, docs/GDD_Crafteo.md §11: 23 materiales intermedios, 22 platos/elixires, 33 piezas de equipo con sus bonificadas, 6 bienes de comercio, 11 muebles exclusivos).
