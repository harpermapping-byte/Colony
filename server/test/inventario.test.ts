...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 389); // 382 (ver historial) + 6 prendas civiles craftables (docs/GDD_Profesiones.md, 2026-08-30) + mesa_ajedrez (docs/GDD_Mesas_Minijuego.md, 2026-08-30)
