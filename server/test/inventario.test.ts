...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 427); // 388 (ver historial) + grasa + 33 cadáveres de caza (docs/GDD_Caza.md, rediseño 2026-08-30) + jarabe_catarro (docs/GDD_Enfermedades.md) + 4 instrumentos musicales (docs/GDD_Instrumentos.md)
