...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 463); // 459 (ver historial) + silla/mesa_comedor/cama_individual/arcon (docs/GDD_Ropa_Procedural.md §Carpintero legendario — carriers de mueble legendario)
