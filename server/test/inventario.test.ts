...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 253); // 240 (ver historial) + 13 de cocina v2 (docs/GDD_Cocina.md, 2026-08-30): asado_huevo + harina/masa_pan/pan/rebanada_pan + mantequilla/queso + olla_barro/olla_metal/cuenco_barro_grande/tinaja_batidos/recipiente_queso/estructura_palos
