...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 460); // 459 (ver historial: 428 = 388 + grasa + 33 cadáveres de caza + jarabe_catarro + 4 instrumentos musicales + mesa_ajedrez, + camisa_seda_noble, + 30 variantes "_bonificado/a(s)" de herrería) + pocion_alquimica (docs/GDD_Pociones.md, 2026-09-01)
