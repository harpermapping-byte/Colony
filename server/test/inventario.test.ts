...
test("cargarCatalogoItems: filtra claves _nota* y trae los ítems reales (fase 1 + arcilla + objetos 'sobreSuperficie' curados de fase 2)", () => {
  ...
  assert.strictEqual(ids.length, 143); // 134 (121 anteriores + 13 de agricultura, docs/GDD_Agricultura.md) + 9 de caza/encurtido (docs/GDD_Caza.md: tendones, tripas, curtiente, cuchillo_desollar, 3 cabezas-trofeo, piel_salada, piel_raspada)
