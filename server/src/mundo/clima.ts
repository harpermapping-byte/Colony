 ...
 * nunca `Math.random()`, mismo criterio "determinista" del resto del
 * proyecto (ver `combate/seleccionArena.ts:hashDeterminista`, aquí sobre un
 * número en vez de un string). Cliente y servidor calculan el MISMO clima
 * en el mismo día sin sincronizar nada — igual que ya hace `tiempoMundo()`
 * con la hora.
 */
