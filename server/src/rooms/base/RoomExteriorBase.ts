...
export abstract class RoomExteriorBase extends Room<HubState> implements RoomConectable {
   ...
   * síncrono) y HubRoom (fauna salvaje, `GestorFaunaSalvaje.quitarIndividuo`
   * async): cada Room solo aporta CÓMO encuentra su candidato más cercano
   * (Schema/gestor distinto) y CÓMO lo quita — comida diet-aware, progreso
   * y creación de mascota son idénticos en los dos sitios.
   */
