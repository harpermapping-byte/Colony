...
- **Tests**: `server/test/construccion.test.ts` ("§1bis: proyectos especiales del jarl") cubre las 3 reglas (jarl, parcela especial, tope 1 solo-edificio) sobre la lógica pura; `interiores/test/catalogo.test.js` confirma que los 13 tipos generan sin error.
