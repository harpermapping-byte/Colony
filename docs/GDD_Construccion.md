...
- El panel de construcción (tecla B) sigue listando los ~800 muebles del catálogo sin indicar cuáles exigen ítem ni cuáles tiene el jugador — `Construible.requiereItemColocar` ya viaja al cliente para hacerlo, no se ha tocado el panel.
...
- **Pendiente**: sin verificar en el hosting real del streamer; el panel de construcción (primer punto de §9.6) sigue sin marcar qué muebles exigen ítem.
