...
- **Elevación en niveles discretos** (6-10 bandas: agua profunda, nivel de agua, llanura, colinas, montaña, cumbre inaccesible). Un salto de más de un nivel entre casillas vecinas genera automáticamente un acantilado infranqueable (salvo rampa/escalera puesta por el bakeador) — esto da fronteras naturales entre zonas y el aspecto 2.5D "terraceado" a la vez. **Aspereza de montaña (2026-08-29, `generar.js`)**: la banda sale de discretizar ruido continuo y suave, así que por construcción casi nunca saltaba más de 1 nivel entre casillas vecinas — el corte de acantilado de arriba casi nunca se disparaba en la práctica, montaña se veía como rampa suave. Se añadió una capa de ruido de alta frecuencia, sumada SOLO donde la banda ya es de montaña (≥4: colinas/montaña/cumbre), que produce saltos reales de 2-3 niveles ahí — roca de verdad en el corte, cantiles visibles al pasear. No toca llanuras/playas/agua ni la elevación continua que usan hidrología/coste de pendiente de caminos (solo la banda discreta que decide terreno).
