...
- **Tenderetes de NPC con economía real** (stock que se regenera solo sin dueño humano, cruzando `poblacion/catalogo/oficiosEdificios.json` con qué vende cada oficio) — hoy los NPC vendedores siguen siendo pura rutina/flavor, sin cambio.
