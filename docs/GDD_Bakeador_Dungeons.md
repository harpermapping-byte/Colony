...
- **Arte 3D real de dungeon**: la caja exterior de las de `estiloExterior:"edificio"` reusa la huella genérica de `tipoEdificioIdExterior` (mismo placeholder que el resto del proyecto) — sin modelo `.glb` específico de dungeon todavía.
