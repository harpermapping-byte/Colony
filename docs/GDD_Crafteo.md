...
**ESTADO: APLICADA (2026-08-29), verificada.** Arquitectura acordada en conversación con el streamer para el sistema de crafteo que `docs/GDD_Profesiones.md` dejó como "pendiente, oficio a oficio". Aquí se fija la FORMA del sistema (dos capas, catálogos, cómo persiste) y se implementa el MECANISMO completo con una receta representativa por familia — el árbol exhaustivo de recetas de cada uno de los 38 oficios sigue siendo trabajo posterior, oficio a oficio, con este contrato ya construido y probado.
