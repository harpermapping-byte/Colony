...
## 10. Panel de crafteo REAL en el cliente + XP/nivel consultable + toast de subida de nivel (2026-09-11, pregunta del streamer: "farmeaste, hiciste crafteos en mesa, subiste nivel de oficios y viste nuevos crafteos, probaste a crear muebles nuevos o los minijuegos?")
...
**Pendiente real**: el panel es un placeholder funcional con el tema compartido (sin iconos de ítem, sin filtros por oficio); cocina/alquimia siguen con sus paneles de proximidad propios (no pasan por este panel — sus "recetas" son el propio minijuego); sin verificar en el hosting real del streamer.
